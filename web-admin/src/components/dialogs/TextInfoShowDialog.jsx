...
const TextInfoShowDialog = ({ showDialog, closeDialog, url, description }) => {
    ...
    return (
        ...
        >
            <DialogContent style={{
                ...
                <div className=''>
                    <p className='font-weight-bolder mt-3 mb-3 h6 contentDialogTitle1'> اینفوگرافی و جداول لیگ</p>
                    ...
                    <div className='d-flex justify-content-end mt-3 m-4'>
                        <button className='buttonSubmitStyle ms-4' onClick={closeDialog} > <i className="fa fa-check ms-1" aria-hidden="true"></i>تایید </button>
                    </div>
                </div>
...
export default TextInfoShowDialog;