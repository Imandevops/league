...
const PlanUndergraduateCorrectionDialog = ({ showDialog, closeDialog,id,planId, planUniqueName, planName, innovativeAspects,innovativeAspectsScore,
    newTopic,newTopicScore,scientificValue,scientificValueScore,explainable,explainableScore,scalability,scalabilityScore,finalScore,finalOpinion }) => {
    ...
    async function handlePlanExpertInfoRegister() {
        ...
        finalScoreNew =((innovativeAspectsScore * 7) + (newTopicScore * 5) + (scientificValueScore * 3)
        + (explainableScore * 2)+ (scalabilityScore * 3)) / 20;

        if(finalScore != finalScoreNew)
        {
            toastError("لطفا امتیاز نهایی دوباره محاسبه گردد")
            return
        }

        try {
            const { status } = await HttpService.put(`/api/league/planUndergraduate/${id}`,body)
            if (status === 200) {
    ...
    return (
        ...
        >
            ...
            <DialogContent style={{
                ...
                <h4 className='d-flex justify-content-center mt-6' >فرم در حال ویرایش  کارشناسی</h4></div>
                            ...
                            <div className='d-flex flex-column'>
                                <div className=' d-flex align-items-center justify-content-center'>     
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        ...
                                        <input type="radio" id="innovativeAspectsTa"  value='5'  defaultChecked={innovativeAspectsScore === 5 ? true : false}   name="innovativeAspects-group"  className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='innovativeAspectsTa'> کاملا موافق</p>
                                    </div>

                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="innovativeAspectsA" value='4'  defaultChecked={innovativeAspectsScore === 4 ? true : false}  name="innovativeAspects-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='innovativeAspectsA'>موافق</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="innovativeAspectsNeutral" value='3'   defaultChecked={innovativeAspectsScore === 3 ? true : false}  name="innovativeAspects-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='innovativeAspectsNeutral'>ارزش خنثی</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="innovativeAspectsDisa" value='2'  defaultChecked={innovativeAspectsScore ===2 ? true : false}    name="innovativeAspects-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='innovativeAspectsDisa'>مخالف</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="innovativeAspectsTdisa" value='1'  defaultChecked={innovativeAspectsScore === 1 ? true : false}    name="innovativeAspects-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='innovativeAspectsTdisa'>کاملا مخالف</p>
                                    </div>
                                
                                    <textarea
                                        style={{width:'400px',height:'70px'}}
                                        defaultValue={innovativeAspects}                                     
                                ...
                                <div className=' d-flex align-items-center justify-content-center'>     
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="newTopicTa" value='5' defaultChecked ={newTopicScore == 5 ? true : false} name="newTopic-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='newTopicTa'>کاملا موافق</p>
                                    </div>

                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="newTopicA" value='4' defaultChecked ={newTopicScore == 4 ? true : false} name="newTopic-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='newTopicA'>موافق</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="newTopicNeutral" value='3' defaultChecked ={newTopicScore == 3 ? true : false} name="newTopic-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='newTopicNeutral'>ارزش خنثی</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="newTopicDisa" value='2' defaultChecked ={newTopicScore == 2 ? true : false} name="newTopic-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='newTopicDisa'>مخالف</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="newTopicTdisa" value='1' defaultChecked ={newTopicScore == 1 ? true : false} name="newTopic-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='newTopicTdisa'>کاملا مخالف</p>
                                    </div>
                                ...
                                <div className=' d-flex align-items-center justify-content-center'>     
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scientificValueTa" value='5' defaultChecked ={scientificValueScore == 5 ? true : false} name="scientificValue-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scientificValueTa'>کاملا موافق</p>
                                    </div>

                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scientificValueA" value='4' defaultChecked ={scientificValueScore == 4 ? true : false} name="scientificValue-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scientificValueA'>موافق</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scientificValueNeutral" value='3' defaultChecked ={scientificValueScore == 3 ? true : false} name="scientificValue-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scientificValueNeutral'>ارزش خنثی</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scientificValueDisa" value='2' defaultChecked ={scientificValueScore == 2 ? true : false} name="scientificValue-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scientificValueDisa'>مخالف</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scientificValueTdisa" value='1' defaultChecked ={scientificValueScore == 1 ? true : false} name="scientificValue-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scientificValueTdisa'>کاملا مخالف</p>
                                    </div>

                                    <textarea
                                            style={{width:'400px',height:'70px'}}      
                                            defaultValue={scientificValue}                                
                                            id='scientificValue'
                                            type="text"                                       
                                            className="uploadPicStyle4 mx-2 border"                                                                                        
                                        />
                                ...
                                <div className=' d-flex align-items-center justify-content-center'>     
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="explainableTa" value='5' defaultChecked ={explainableScore == 5 ? true : false} name="explainable-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='explainableTa'>کاملا موافق</p>
                                    </div>

                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="explainableA" value='4' defaultChecked ={explainableScore == 4 ? true : false} name="explainable-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='explainableA'>موافق</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="explainableNeutral" value='3' defaultChecked ={explainableScore == 3 ? true : false} name="explainable-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='explainableNeutral'>ارزش خنثی</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="explainableDisa" value='2' defaultChecked ={explainableScore == 2 ? true : false} name="explainable-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='explainableDisa'>مخالف</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="explainableTdisa" value='1' defaultChecked ={explainableScore == 1} name="explainable-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='explainableTdisa'>کاملا مخالف</p>
                                    </div>

                                    <textarea
                                            style={{width:'400px',height:'70px'}}    
                                            defaultValue={explainable}                                        
                                            id='explainable'
                                            type="text"                                       
                                            className="uploadPicStyle4 mx-2 border"                                                                                        
                                        />
                                ...
                                <div className=' d-flex align-items-center justify-content-center'>     
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scalabilityTa" value='5' defaultChecked ={scalabilityScore == 5 ? true : false} name="scalability-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scalabilityTa'>کاملا موافق</p>
                                    </div>

                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scalabilityA" value='4' defaultChecked ={scalabilityScore == 4 ? true : false} name="scalability-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scalabilityA'>موافق</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scalabilityNeutral" value='3' defaultChecked ={scalabilityScore == 3 ? true : false} name="scalability-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scalabilityNeutral'>ارزش خنثی</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scalabilityDisa" value='2' defaultChecked ={scalabilityScore == 2 ? true : false} name="scalability-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scalabilityDisa'>مخالف</p>
                                    </div>
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input type="radio" id="scalabilityTdisa" value='1' defaultChecked ={scalabilityScore == 1 ? true : false} name="scalability-group" className='m-0 p-0' />
                                        <p className="pcenter my-0 flex-grow-1 py-1 px-1 mx-2" name='scalabilityTdisa'>کاملا مخالف</p>
                                    </div>

                                    <textarea
                                            style={{width:'400px',height:'70px'}}  
                                            defaultValue={scalability}                                        
                                            id='scalability'
                                            type="text"                                       
                                            className="uploadPicStyle4 mx-2 border"                                                                                        
                                        />
                                    ...
                                    <div className=' d-flex align-items-center justify-content-center'>
                                        <input
                                            style={{width:'100px',height:'70px',textAlign:'center',fontWeight:'bold',fontSize:'30px',color:'blue',
                                                        backgroundColor : finalScore > 2.5 ? 'green' : 'red'}}                                                         
...
export default PlanUndergraduateCorrectionDialog;